<?php //query per editim e postimeve nepermjet butonit apply extra feature
if(isset($_POST['checkBoxArray'])){
    
foreach($_POST['checkBoxArray'] as $checkBoxValue){
    
    $bulk_options = $_POST['bulk_options'];
    //switch kushti per te edituar post_status ose per te fshire nepermjet apply button
    switch ($bulk_options) {
